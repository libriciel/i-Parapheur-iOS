...
+ (NSValueTransformer *)canAddJSONTransformer { return [StringUtils getNullToFalseValueTransformer]; }
+ (NSValueTransformer *)isSentJSONTransformer { return [StringUtils getNullToFalseValueTransformer]; }

+ (NSValueTransformer *)metadatasJSONTransformer { return [StringUtils getNullToEmptyDictionaryValueTransformer]; }

+ (NSValueTransformer *)documentsJSONTransformer { return [StringUtils getNullToEmptyArrayValueTransformer]; }
